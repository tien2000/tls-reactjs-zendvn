...
class Sort extends Component{
	...
	render(){	
		...
		let strSort = orderBy.charAt(0).toUpperCase() + orderBy.slice(1) + ' - ' + orderDir.charAt(0).toUpperCase() + orderDir.slice(1);
			...
			<div className="col-xs-3 col-sm-3 col-md-3 col-lg-3">
				<div className="dropdown">
					...
					<ul className="dropdown-menu" aria-labelledby="dropdownMenu1">
						...
						<li> <a onClick={() => this.handleSort('level', 'asc')} href="# ">Level ASC</a> </li>
